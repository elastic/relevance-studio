    ...
    <Router>
      <Switch>
        ...
        <Route path='/projects/:project_id'>
          <ProjectContextRoute>
            <Switch>
              <Route path='/projects/:project_id/displays' exact render={() => {
              ...
              <Route path='/projects/:project_id/judgements' exact render={() => {
                document.title = `Judgements - ${title}`
                return <Pages.Judgements />
              }} />
              <Route path='/projects/:project_id/scenarios' exact render={() => {
                document.title = `Scenarios - ${title}`
                return <Pages.Scenarios />
              }} />
              <Route path='/projects/:project_id/strategies' exact render={() => {
              ...
              <Route path='/projects/:project_id/benchmarks/:benchmark_id' exact render={(r) => {
                document.title = `Benchmarks - ${r.match.params.benchmark_id} - ${title}`
                return <Pages.BenchmarksView />
              }} />
              <Route path='/projects/:project_id/benchmarks/:benchmark_id/evaluations/:evaluation_id' render={(r) => {

...
def conversations_create():
    ...
    return api.conversations.create(doc, _id, user=_request_user(), es_client=_request_es_client())

@api_route("/api/conversations/<string:_id>", methods=["PUT"])
def conversations_update(_id):
    doc_partial = request.get_json()
    return api.conversations.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def workspaces_create():
    doc = request.get_json()
    _id = doc.pop("_id", None) # accept an optional _id if given
    return api.workspaces.create(doc, _id, user=_request_user(), es_client=_request_es_client())

@api_route("/api/workspaces/<string:_id>", methods=["PUT"])
def workspaces_update(_id):
    doc_partial = request.get_json()
    return api.workspaces.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def displays_create(workspace_id):
    ...
    _id = doc.pop("_id", None) # accept an optional _id if given
    return api.displays.create(doc, _id, user=_request_user(), es_client=_request_es_client())
...
def displays_update(workspace_id, _id):
    ...
    return api.displays.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def scenarios_create(workspace_id):
    ...
    validate_workspace_id_match(doc, workspace_id)
    doc["workspace_id"] = workspace_id # ensure workspace_id from path is in doc
    return api.scenarios.create(doc, user=_request_user(), es_client=_request_es_client())
...
def scenarios_update(workspace_id, _id):
    ...
    validate_workspace_id_match(doc_partial, workspace_id)
    doc_partial["workspace_id"] = workspace_id # ensure workspace_id from path is in doc_partial
    return api.scenarios.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def strategies_create(workspace_id):
    ...
    doc["workspace_id"] = workspace_id # ensure workspace_id from path is in doc
    _id = doc.pop("_id", None) # accept an optional _id if given
    return api.strategies.create(doc, _id, user=_request_user(), es_client=_request_es_client())
...
def strategies_update(workspace_id, _id):
    ...
    return api.strategies.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def benchmarks_create(workspace_id):
    ...
    doc["workspace_id"] = workspace_id # ensure workspace_id from path is in doc
    _id = doc.pop("_id", None) # accept an optional _id if given
    return api.benchmarks.create(doc, _id, user=_request_user(), es_client=_request_es_client())
...
def benchmarks_update(workspace_id, _id):
    ...
    validate_workspace_id_match(doc_partial, workspace_id)
    doc_partial["workspace_id"] = workspace_id # ensure workspace_id from path is in doc_partial
    return api.benchmarks.update(_id, doc_partial, user=_request_user(), es_client=_request_es_client())
...
def evaluations_create(workspace_id, benchmark_id):
    ...
    return api.evaluations.create(workspace_id, benchmark_id, task, user=_request_user(), es_client=_request_es_client())
...
def setup_run():
    return api.setup.run(es_client=_request_es_client())

@api_route("/api/upgrade", methods=["POST"])
def upgrade_run():
    return api.setup.upgrade(es_client=_request_es_client())

...
<div style="background: linear-gradient(180deg,#111d40,#091022); border-radius: 4px; padding: 16px 24px; margin: 0 0 -20px 0; max-width: 600px; overflow: hidden;">
    <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px;">
        <code style="background: none; color: #48efcf; font-size: 14px; font-weight: 600; white-space: nowrap; overflow-x: auto;">bash &lt;(curl -fsSL https://ela.st/relevance-studio-quickstart)</code>

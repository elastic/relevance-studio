...
The [MCP Server](docs/{{VERSION}}/reference/architecture.md#mcp-server) for Relevance Studio implements the core [REST API](docs/{{VERSION}}/reference/rest-api.md) resource operations as MCP tools.
